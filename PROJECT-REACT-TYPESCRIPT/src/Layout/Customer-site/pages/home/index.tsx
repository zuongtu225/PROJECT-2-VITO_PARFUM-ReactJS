...
const Home = () => {
  ...
  let userLogin = auth ? JSON.parse(auth) : {}; // chỉ lấy id thôi
  // get, render => products
    ...
    <div>
      ...
      <div className="home-banner-block container m-3 ">
        <div className="block-man home-block relative">
          <img
            src="https://theme.hstatic.net/1000340570/1000964732/14/banner-nu-desk.jpg?v=2650"
            alt=""
          />
          <NavLink
        ...
        <div className="block-woman home-block relative">
          <img
            src="https://theme.hstatic.net/1000340570/1000964732/14/banner-nam-desk.jpg?v=2650"
            alt=""
          />
          <NavLink
            className="absolute bottom-3 right-8 text-white "
        ...
        <div className="block-niche home-block relative ">
          <img
            src="https://theme.hstatic.net/1000340570/1000964732/14/banner-niche-desk.jpg?v=2650"
            alt=""
          />
          <NavLink
            className="absolute bottom-3 right-8 text-white "
